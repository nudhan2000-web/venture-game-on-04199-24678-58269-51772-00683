...
const AboutSection = () => {
  ...
  return (
    <section id="about" ref={ref} className="relative py-12 md:py-20 px-4 flex items-center justify-center overflow-hidden max-w-full">
